...
// opts.emit (AG adapter): receives the finished directive/ask string; the AG
// shim maps it onto AG's Stop decision channel ({decision:'continue', reason}
// — reason lands as a system message and the loop runs one more turn, the
// closest AG analogue of CC's Stop-block). The crossing logic,
// consume-at-emission included, is byte-shared.
...
// injects its own sanctioned emit channel via the opts params above.
